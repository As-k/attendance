...
public class MondayFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lv = v.findViewById(R.id.lv_mon);
        al = new ArrayList();

        dr = FirebaseDatabase.getInstance().getReference().child(WelcomeActivity.id).child(WelcomeActivity.university).child(SemesterDetailsActivity.s).child(MondayActivity.Day);
