...
public class SaturdayActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        dr.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (int i=0; i<sp.length; i++) {
                    aa = new ArrayAdapter(SaturdayActivity.this, R.layout.subject_spinner_style, al);
                    sp[i].setAdapter(aa);
                }
            }
            @Override
    ...
    public void nextTue(View v) {
        ...
        adb.setMessage("Process to Creation of the TimeTable?");
        adb.setCancelable(false);
        adb.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(SaturdayActivity.this, "Ok", Toast.LENGTH_SHORT).show();
